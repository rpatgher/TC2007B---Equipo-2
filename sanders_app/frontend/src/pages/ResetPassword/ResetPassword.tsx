...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if(!password || !password2) {
            notify('Debes ingresar una contraseña', { type:'error' });
            return;
        }
        if(password !== password2) {
        ...
        try {
            ...
            notify('Contraseña cambiada correctamente', { type:'success' });
            navigate('/dashboard/login');
        } catch (error) {
            notify('Error al cambiar contraseña', { type:'error' });
        }
    ...
    return (
        <main className={styles.main}>
            ...
            >
                <h1 className={styles.heading}>Recuperar Acceso</h1>
                <p className={styles.description}>Cambia tu contraseña para recuperar tu acceso y seguir formando parte de Fundación Sanders.</p>
